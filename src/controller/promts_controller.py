...
@router.get("/list")
def list_prompts(include_inactive: bool = False, service: StoreService = Depends(store_service)) -> PromptVersionListResponse:
...
def list_prompts_by_role(agent_role: str, include_inactive: bool = False, service: StoreService = Depends(store_service)) -> PromptVersionListResponse:
...
@router.post("/create")
def create_prompt(request: CreatePromptRequest, service: StoreService = Depends(store_service)) -> PromptVersionResponse:
...
def update_prompt(version_id: int, request: UpdatePromptRequest, service: StoreService = Depends(store_service)) -> PromptVersionResponse:
...
def list_instructions(type: InstructionType | None = None, include_inactive: bool = False, service: StoreService = Depends(store_service)) -> PromptInstructionListResponse:
...
def create_instruction(request: CreateInstructionRequest, service: StoreService = Depends(store_service)) -> PromptInstructionResponse:
...
def update_instruction(instruction_id: int, request: UpdateInstructionRequest, service: StoreService = Depends(store_service)) -> PromptInstructionResponse:
